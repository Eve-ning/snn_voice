...
def piczak_snn_init(self, lif_beta: float, n_classes: int):
    """ Initializes the Piczak __init__ blocks """
    self.net = nn.Sequential(
        OrderedDict([
            ('snn1', PiczakSNNBlock(1, 80, (57, 6), (1, 1), (4, 3), (1, 3), lif_beta, 0.5)),
            ('snn2', PiczakSNNBlock(80, 80, (1, 3), (1, 1), (1, 3), (1, 3), lif_beta, 0)),
            ...
            ('fc3', nn.Sequential(nn.Linear(5000, n_classes))),
        ])
    )
